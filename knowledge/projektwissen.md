...
Lesbarkeits-Ausbau auf Operator-Frage nach Klarheit der Knotenfarben und einer Legende (44547c7). Drei Hebel rein im Template. Erstens Hub-Labels, die Top 24 Knoten nach PageRank sind dauerhaft beschriftet, der Rest erscheint ab einer Zoomschwelle, bei Auswahl das Ego-Netz. Zweitens Community-Regionen, je Community liegt eine blasse Convex Hull hinter den Knoten, beschriftet mit ihrem dominanten Ordner, so wird aus einer reinen Fuellfarbe eine benennbare Region. Drittens erklaert die Legende jetzt beide Farbachsen ausdruecklich, Fuellung gleich Community und im Graphen als benannte Region hinterlegt, Ring gleich Aussagetyp. Damit die Hulls als Regionen tragen, ersetzt eine Cluster-Kraft (forceX und forceY je Community-Anker auf einem Ring) das fruehere forceCenter, sodass sich die Communities raeumlich trennen statt zu einem Ball zu ueberlappen, und der Zoom haengt an einer eigenen Viewport-Gruppe statt an allen Ebenen. Ehrlicher Nebenbefund, der Ordner Projects erscheint dreimal als Region-Label, weil er topologisch in drei Link-Communities zerfaellt, das ist die Triangulations-Aussage selbst und kein Fehler. _build_payload ist unangetastet, damit bleiben Byte-Determinismus und Privacy-Netz gueltig, 51 Tests gruen, Browser-Sichtung im Vordergrund mit neun benannten Regionen und 24 Hub-Labels. Durable Lehre, ein d3-Force-Graph braucht den Tab im Vordergrund, sonst pausiert requestAnimationFrame und die Simulation tickt nicht.
